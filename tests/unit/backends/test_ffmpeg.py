"""Tests for the FFmpeg subprocess based frame extraction backend."""
...
pytestmark = pytest.mark.skipif(
    ...
    reason="ffmpeg and ffprobe binaries are required",
)


def test_is_available_returns_true_in_this_environment() -> None:
    assert FFmpegBackend.is_available() is True
...
def test_frame_shape_and_dtype(synthetic_video_path):
    ...
    assert first.source_backend == "ffmpeg"
